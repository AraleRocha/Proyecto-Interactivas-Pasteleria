...
<style>
    ...
    .nav-drop-item .material-symbols-outlined {
        font-size: 17px;
        color: var(--on-surface-variant);
    }
    ...
    .nav-drop-item.danger .material-symbols-outlined {
        color: var(--error);
    }
    ...
    .nav-mobile-link .material-symbols-outlined {
        font-size: 18px;
    }
...
<div class="nav-inner">
    ...
    <div class="nav-links">
        ...
        <a href="{{ route('dashboard') }}"
           class="nav-link {{ request()->routeIs('admin.dashboard') || request()->routeIs('client.dashboard') ? 'active' : '' }}"
           wire:navigate>
        ...
        @if(auth()->user()->role === 'cliente')
            ...
            <a href="{{ route('client.catalogo.index') }}"
               class="nav-link {{ request()->routeIs('client.catalogo.*') ? 'active' : '' }}"
               wire:navigate>
            ...
            <a href="{{ route('client.pedidos.index') }}"
               class="nav-link {{ request()->routeIs('client.pedidos.*') ? 'active' : '' }}"
               wire:navigate>
    ...
    <div class="nav-right">
        ...
        <x-dropdown align="right" width="56">
            ...
            <x-slot name="trigger">
                <button class="nav-user-btn">
                    ...
                    <span class="material-symbols-outlined nav-chevron">
                        expand_more
                    </span>
                </button>
            </x-slot>
        ...
        <button @click="open = !open" class="nav-hamburger">
            ...
            <span class="material-symbols-outlined" x-show="!open">
                menu
            </span>

            <span class="material-symbols-outlined" x-show="open" x-cloak>
                close
            </span>
        </button>
    </div>
