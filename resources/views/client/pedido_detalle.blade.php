...
.est-horneando { background:#fffbeb; color:#92400e; } .est-horneando .estado-dot { background:#f59e0b; }
...
<div class="det-wrap">
    ...
    <a href="{{ route('client.pedidos.index') }}" class="det-back">
            ...
            @if($pedido->estado === 'pendiente' && auth()->user()->role !== 'admin')
                <div class="det-card">
                    ...
                    <div class="det-card-body" style="display:flex;flex-direction:column;gap:12px;">
                        ...
                        <form method="POST" action="{{ route('client.pedidos.comprar', $pedido) }}">
                            @csrf
                            <button type="submit" class="btn-primary">
